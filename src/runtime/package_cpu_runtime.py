...
def _stage(stage, artifacts, target, version, revision):
    ...
    manifest = {
        ...
        "runner_protocol": 1,
        "source": (
            "https://github.com/DrAlexLiu/moonraker-pinozcam/commit/%s" %
            revision
        ),
        "target": target,
    }
...
setup(
    ...
    url="https://github.com/DrAlexLiu/moonraker-pinozcam",
    project_urls={{
        "Source": "https://github.com/DrAlexLiu/moonraker-pinozcam",
    }},
